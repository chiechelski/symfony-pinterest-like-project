...
class appProdUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (rtrim($pathinfo, '/') === '') {
            ...
            return array (  '_controller' => 'PinterestLike\\StaticBundle\\Controller\\DefaultController::indexAction',  '_route' => 'homepage',);
        }

        // about
        if ($pathinfo === '/about') {
            return array (  '_controller' => 'PinterestLike\\StaticBundle\\Controller\\DefaultController::aboutAction',  '_route' => 'about',);
        }

        if (0 === strpos($pathinfo, '/c')) {
            // filter_category
            if (0 === strpos($pathinfo, '/category') && preg_match('#^/category/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'filter_category')), array (  '_controller' => 'PinterestLike\\StaticBundle\\Controller\\DefaultController::categoryAction',));
            }

            // filter_colour
            if (0 === strpos($pathinfo, '/colour') && preg_match('#^/colour/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'filter_colour')), array (  '_controller' => 'PinterestLike\\StaticBundle\\Controller\\DefaultController::colourAction',));
            }
        ...
        // terms
        if ($pathinfo === '/terms') {
            return array (  '_controller' => 'PinterestLike\\StaticBundle\\Controller\\DefaultController::termsAction',  '_route' => 'terms',);
        }
        ...
        if (0 === strpos($pathinfo, '/login')) {
            ...
            if (0 === strpos($pathinfo, '/login/check-')) {
                ...
                // yahoo_login
                if ($pathinfo === '/login/check-yahoo') {
                    return array('_route' => 'yahoo_login');
                }
