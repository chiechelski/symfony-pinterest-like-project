...
class appProdDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'hwi_oauth.resource_owner.yahoo' => 'getHwiOauth_ResourceOwner_YahooService',
            ...
            'hwi_oauth.user.provider.entity' => 'getHwiOauth_User_Provider_EntityService',
            ...
            'pinterestlike.twig.side_data_helper' => 'getPinterestlike_Twig_SideDataHelperService',
            'pinterestlike_user.registration.form.type' => 'getPinterestlikeUser_Registration_Form_TypeService',
            'pinterestlike_user_upload_listener' => 'getPinterestlikeUserUploadListenerService',
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\ConfigurationResource(array('jquery_file_upload' => array(0 => array(), 1 => array(), 2 => array()))), 'config');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'PinterestLikeStaticBundle', ($this->targetDirs[2].'/Resources/PinterestLikeStaticBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'PinterestLikeStaticBundle', ($this->targetDirs[3].'/src/PinterestLike/StaticBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addListenerService('oneup_uploader.post_persist', array(0 => 'pinterestlike_user_upload_listener', 1 => 'onUpload'), 0);
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'PinterestLike', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/vendor/gedmo/doctrine-extensions/lib/Gedmo/Translatable/Entity'), 1 => ($this->targetDirs[3].'/src/PinterestLike/CoreBundle/Entity')));
        ...
        $d->addDriver($b, 'PinterestLike\\CoreBundle\\Entity');
        $d->addDriver($c, 'FOS\\UserBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('Gedmo' => 'Gedmo\\Translatable\\Entity', 'PinterestLikeCoreBundle' => 'PinterestLike\\CoreBundle\\Entity', 'FOSUserBundle' => 'FOS\\UserBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_f89e9c6f6dfc996c855934662a59ae67789d510a6ee3da3011726eed7c8f145f');
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('PinterestLike\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form'] = $this->get('form.factory')->createNamed('fos_user_registration_form', 'PinterestLike_user_registration', NULL, array('validation_groups' => array(0 => 'Registration', 1 => 'Default')));
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('PinterestLike\\UserBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'PinterestLike\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['happyr.google.api.client'] = new \HappyR\Google\ApiBundle\Services\GoogleClient(array('application_name' => 'PinterestLike', 'oauth2_client_id' => '469994775960-qqjm206pnsgkgk4f2o0dmoq4em5npnr1.apps.googleusercontent.com', 'oauth2_client_secret' => 'tHHUoDt9_qvgq9BPGQDdSpD0', 'oauth2_redirect_uri' => 'https://dev.PinterestLike.com/login/check-google', 'developer_key' => 'AIzaSyB2YYnYFdcWYKS2ng4xeis_Pb52J0B1FvU', 'site_name' => 'PinterestLike.com'));
    }
    ...
    {
        return $this->services['hwi_oauth.resource_owner.facebook'] = new \HWI\Bundle\OAuthBundle\OAuth\ResourceOwner\FacebookResourceOwner($this->get('hwi_oauth.http_client'), $this->get('security.http_utils'), array('client_id' => '1397106410610225', 'client_secret' => 'dad0a6c737d4a71fb54982d19fdc2f83', 'scope' => 'email', 'options' => array('display' => 'popup'), 'paths' => array()), 'facebook', $this->get('hwi_oauth.storage.session'));
    }
    ...
    {
        return $this->services['hwi_oauth.resource_owner.google'] = new \HWI\Bundle\OAuthBundle\OAuth\ResourceOwner\GoogleResourceOwner($this->get('hwi_oauth.http_client'), $this->get('security.http_utils'), array('client_id' => '469994775960-qqjm206pnsgkgk4f2o0dmoq4em5npnr1.apps.googleusercontent.com', 'client_secret' => 'tHHUoDt9_qvgq9BPGQDdSpD0', 'scope' => 'email profile', 'paths' => array(), 'options' => array()), 'google', $this->get('hwi_oauth.storage.session'));
    }

    /**
     * Gets the 'hwi_oauth.resource_owner.yahoo' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \HWI\Bundle\OAuthBundle\OAuth\ResourceOwner\YahooResourceOwner A HWI\Bundle\OAuthBundle\OAuth\ResourceOwner\YahooResourceOwner instance.
     */
    protected function getHwiOauth_ResourceOwner_YahooService()
    {
        return $this->services['hwi_oauth.resource_owner.yahoo'] = new \HWI\Bundle\OAuthBundle\OAuth\ResourceOwner\YahooResourceOwner($this->get('hwi_oauth.http_client'), $this->get('security.http_utils'), array('client_id' => 'dj0yJmk9enBCa0tNQ0R1c2JNJmQ9WVdrOVltUTFjV1JQTm5FbWNHbzlNQS0tJnM9Y29uc3VtZXJzZWNyZXQmeD05YQ--', 'client_secret' => '35dcfb281e922308e0a2e2be7d9d7aaf97cf646d', 'paths' => array(), 'options' => array()), 'yahoo', $this->get('hwi_oauth.storage.session'));
    }
    ...
    {
        $this->services['hwi_oauth.resource_ownermap.main'] = $instance = new \HWI\Bundle\OAuthBundle\Security\Http\ResourceOwnerMap($this->get('security.http_utils'), array(0 => 'facebook', 1 => 'google', 2 => 'yahoo'), array('facebook' => '/login/check-facebook', 'google' => '/login/check-google', 'yahoo' => '/login/check-yahoo', 'my_custom_provider' => '/login/check-custom'));
    ...
    /**
     * Gets the 'hwi_oauth.user.provider.entity' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getHwiOauth_User_Provider_EntityService()
    {
        return $this->services['hwi_oauth.user.provider.entity'] = new \HWI\Bundle\OAuthBundle\Security\Core\User\OAuthUserProvider();
    }
    ...
    {
        return $this->services['hwi_oauth.user.provider.fosub_bridge'] = new \HWI\Bundle\OAuthBundle\Security\Core\User\FOSUBUserProvider($this->get('fos_user.user_manager'), array('facebook' => 1397108077276725, 'google' => 'google_id'));
    }
    ...
    {
        return $this->services['liip_imagine.cache.signer'] = new \Liip\ImagineBundle\Imagine\Cache\Signer('fc3db19055fd0d7430fddf5c4818d443ea4f2518');
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \PinterestLike\UserBundle\Security\Core\User\FOSUBUserProvider A PinterestLike\UserBundle\Security\Core\User\FOSUBUserProvider instance.
     */
    protected function getMyUserProviderService()
    {
        return $this->services['my_user_provider'] = new \PinterestLike\UserBundle\Security\Core\User\FOSUBUserProvider($this->get('fos_user.user_manager'), array('facebook' => 'facebook_id', 'google' => 'google_id', 'yahoo' => 'yahoo_id'));
    }
    ...
    protected function getOneupUploader_Controller_GalleryService()
    {
        ...
        return $this->services['oneup_uploader.controller.gallery'] = $this->scopedServices['request']['oneup_uploader.controller.gallery'] = new \Oneup\UploaderBundle\Controller\BlueimpController($this, $this->get('oneup_uploader.storage.gallery'), $this->get('oneup_uploader.error_handler.blueimp'), array('frontend' => 'blueimp', 'custom_frontend' => array('name' => NULL, 'class' => NULL), 'storage' => array('service' => NULL, 'type' => 'filesystem', 'filesystem' => NULL, 'directory' => ($this->targetDirs[2].'/../web/uploads/gallery'), 'stream_wrapper' => NULL, 'sync_buffer_size' => '100K'), 'route_prefix' => '', 'allowed_mimetypes' => array(), 'disallowed_mimetypes' => array(), 'error_handler' => NULL, 'max_size' => 9223372036854775807, 'use_orphanage' => false, 'enable_progress' => false, 'enable_cancelation' => false, 'namer' => 'oneup_uploader.namer.uniqid'), 'gallery');
    }
    ...
    {
        return $this->services['oneup_uploader.storage.gallery'] = new \Oneup\UploaderBundle\Uploader\Storage\FilesystemStorage(($this->targetDirs[2].'/../web/uploads/gallery'));
    }
    ...
    {
        return $this->services['oneup_uploader.templating.uploader_helper'] = new \Oneup\UploaderBundle\Templating\Helper\UploaderHelper($this->get('router'), array('gallery' => 2097152));
    }
    ...
    /**
     * Gets the 'pinterestlike.twig.side_data_helper' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \PinterestLike\CoreBundle\Twig\SiteDataHelperExtension A PinterestLike\CoreBundle\Twig\SiteDataHelperExtension instance.
     */
    protected function getPinterestlike_Twig_SideDataHelperService()
    {
        return $this->services['pinterestlike.twig.side_data_helper'] = new \PinterestLike\CoreBundle\Twig\SiteDataHelperExtension($this);
    }

    /**
     * Gets the 'pinterestlike_user.registration.form.type' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \PinterestLike\UserBundle\Form\Type\RegistrationFormType A PinterestLike\UserBundle\Form\Type\RegistrationFormType instance.
     */
    protected function getPinterestlikeUser_Registration_Form_TypeService()
    {
        return $this->services['pinterestlike_user.registration.form.type'] = new \PinterestLike\UserBundle\Form\Type\RegistrationFormType();
    }

    /**
     * Gets the 'pinterestlike_user_upload_listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \PinterestLike\UserBundle\EventListener\UploadListener A PinterestLike\UserBundle\EventListener\UploadListener instance.
     */
    protected function getPinterestlikeUserUploadListenerService()
    {
        return $this->services['pinterestlike_user_upload_listener'] = new \PinterestLike\UserBundle\EventListener\UploadListener($this->get('doctrine'), $this);
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('PinterestLike\\UserBundle\\Entity\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'sha512', 1 => true, 2 => 5000))));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $h = new \Symfony\Component\Security\Http\Firewall\LogoutListener($a, $d, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($d, '/'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => '/logout'));
        $h->addHandler($this->get('security.logout.handler.session'));

        $i = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationSuccessHandler($d, array());
        ...
        $j = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($e, $d, array(), $b);
        $j->setOptions(array('login_path' => '/login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'));

        $k = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationSuccessHandler($d, array());
        ...
        $l = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($e, $d, array(), $b);
        $l->setOptions(array('login_path' => '/login', 'failure_path' => '/login', 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'));

        $m = new \HWI\Bundle\OAuthBundle\Security\Http\Firewall\OAuthListener($a, $f, $g, $d, 'main', $k, $l, array('use_forward' => false, 'check_path' => '/login_check', 'require_previous_session' => true), $b, $c);
        $m->setResourceOwnerMap($this->get('hwi_oauth.resource_ownermap.main'));
        $m->setCheckPaths(array(0 => '/login/check-facebook', 1 => '/login/check-google', 2 => '/login/check-yahoo', 3 => '/login/check-custom'));

        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('fos_user.user_provider.username_email')), 'main', $b, $c), 2 => $h, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $f, $g, $d, 'main', $i, $j, array('check_path' => '/login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $b, $c, $this->get('form.csrf_provider')), 4 => $m, 5 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '564fd2805462b', $b, $f), 6 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $d, 'main', new \HWI\Bundle\OAuthBundle\Security\Http\EntryPoint\OAuthEntryPoint($e, $d, '/login', false), NULL, NULL, $b));
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension($this->get('pinterestlike.twig.side_data_helper'));
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), false, array(), array(0 => 'PinterestLikeStaticBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/PinterestLike/CoreBundle/Resources/views'), 'PinterestLikeCore');
        $instance->addPath(($this->targetDirs[3].'/src/PinterestLike/StaticBundle/Resources/views'), 'PinterestLikeStatic');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('fc3db19055fd0d7430fddf5c4818d443ea4f2518');
    }
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        ...
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($a, $b, 'demo_secured_area', $c, true), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($a, $b, 'main', $c, true), 2 => new \HWI\Bundle\OAuthBundle\Security\Core\Authentication\Provider\OAuthProvider($this->get('my_user_provider'), $this->get('hwi_oauth.resource_ownermap.main'), $b), 3 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('564fd2805462b')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'PinanoBootstrap3Bundle' => 'Pinano\\Bootstrap3Bundle\\PinanoBootstrap3Bundle',
                'HWIOAuthBundle' => 'HWI\\Bundle\\OAuthBundle\\HWIOAuthBundle',
                'OneupUploaderBundle' => 'Oneup\\UploaderBundle\\OneupUploaderBundle',
                'PinterestLikeCoreBundle' => 'PinterestLike\\CoreBundle\\PinterestLikeCoreBundle',
                'PinterestLikeStaticBundle' => 'PinterestLike\\StaticBundle\\PinterestLikeStaticBundle',
            ...
            'locale' => 'en',
            'secret' => 'fc3db19055fd0d7430fddf5c4818d443ea4f2518',
            ...
            'kernel.secret' => 'fc3db19055fd0d7430fddf5c4818d443ea4f2518',
            ...
            'happy_r_google_api' => array(
                'application_name' => 'PinterestLike',
                'oauth2_client_id' => '469994775960-qqjm206pnsgkgk4f2o0dmoq4em5npnr1.apps.googleusercontent.com',
                'oauth2_client_secret' => 'tHHUoDt9_qvgq9BPGQDdSpD0',
                'oauth2_redirect_uri' => 'https://dev.PinterestLike.com/login/check-google',
                'developer_key' => 'AIzaSyB2YYnYFdcWYKS2ng4xeis_Pb52J0B1FvU',
                'site_name' => 'PinterestLike.com',
            ),
            ...
            'fos_user.model.user.class' => 'PinterestLike\\UserBundle\\Entity\\User',
            ...
            'fos_user.registration.form.type' => 'PinterestLike_user_registration',
